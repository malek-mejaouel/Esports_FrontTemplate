...
import { mockMatches, mockTeams, mockTournaments } from '@/data/mockData';
...
const Matches = () => {
  ...
  const uniqueGames = Array.from(new Set(mockMatches.map(m => m.game)));

  return (
    <div className="container mx-auto py-8 space-y-10">
      <h1 className="text-5xl font-extrabold neon-text-blue text-center mb-8">Matches</h1>

      <div className="flex flex-col md:flex-row gap-4 mb-8 glassmorphism p-6 rounded-xl border border-border shadow-lg">
        <Input
          placeholder="Search matches by team or game..."
      ...
      {filteredMatches.length === 0 ? (
        <p className="text-center text-xl text-gray-400">No matches found matching your criteria.</p>
      ) : (
